...
function woocommerce_mrova_ccave_init() {
    ...
    class WC_Mrova_Ccave extends WC_Payment_Gateway {
                        ...
                        if($order -> status !=='completed'){
                            if($Checksum=="true")
                            {
                                ...
                                if($AuthDesc=="Y"){
                                    ...
                                    $this -> msg = "Thank you for shopping with us. Your account has been charged and your transaction is successful. We will be shipping your order to you soon.";
                                    $this -> class = 'success';
                                    ...
                                    $this -> msg = "Thank you for shopping with us. We will keep you posted regarding the status of your order through e-mail";
                                    $this -> class = 'info';
                                    ...
                                    $this -> class = 'error';
                                    $this -> msg = "Thank you for shopping with us. However, the transaction has been declined.";
                                ...
                                $this -> class = 'error';
                                $this -> msg = "Security Error. Illegal access detected";
        ...
        function showMessage($content){
            return '<div class="box '.$this -> class.'-box">'.$this -> msg.'</div>'.$content;
        }
        /**
